...
/*   Updated: 2020/01/24 19:23:10 by mcarrete         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			type_reader(char *str, int i, va_list args,
				t_modifiers *flags);
void			check_error(t_modifiers *flags);
int				int_input(char str2_i, int i, va_list args,
				t_modifiers *flags);
int				int_out(char *str_int, char *str_arg, va_list args,
				t_modifiers *flags);
int				hex_output(char str2_i, int i, va_list args,
				t_modifiers *flags);
int				pointer_output(char str2_i, int i, va_list args,
				t_modifiers *flags);
int				float_output(char str2_i, int i, va_list args,
				t_modifiers *flags);
void			char_output(char str2_i, int i, va_list args,
				t_modifiers *flags);
void			percent_output(char str2_i, int i, va_list args,
				t_modifiers *flags);
void			string_output(char str2_i, int i, va_list args,
				t_modifiers *flags);
...
int				flag_parser(char *str2, int i, va_list args,
				t_modifiers *flags);
void			flag_reader(char *str2, t_modifiers *flags);
void			flags_initialiser(t_modifiers *flags);
void			precision_definer(char *str2, va_list args,
				t_modifiers *flags);
void			star_precision(int precision, va_list args,
				t_modifiers *flags);
void			width_definer(char *str2, va_list args, t_modifiers *flags);
char			*manage_negatives(char *str_int, char *str_arg,
				t_modifiers *flags);
